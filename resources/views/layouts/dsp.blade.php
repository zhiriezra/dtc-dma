            ...
            <div class="flex flex-col w-64 bg-green-800">
                ...
                <div class="flex flex-col flex-grow px-4 py-4 overflow-y-auto">
                    <div class="flex flex-col flex-grow space-y-1">
                        <a href="{{ route('dsp') }}" class="flex items-center px-4 py-3 text-white rounded-lg {{ request()->routeIs('dsp') ? 'bg-green-700' : 'hover:bg-green-700' }}">
                        ...
                        <a href="{{ route('new-assessments') }}" class="flex items-center px-4 py-3 text-white rounded-lg {{ request()->routeIs('new-assessments') ? 'bg-green-700' : 'hover:bg-green-700' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="{{ route('dsp-assessments') }}" class="flex items-center px-4 py-3 text-white rounded-lg {{ request()->routeIs('dsp-assessments') ? 'bg-green-700' : 'hover:bg-green-700' }}">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex justify-between flex-1 px-4">
                    <div class="flex flex-1">
                        <div class="flex items-center w-full md:ml-0">
                            <h1 class="text-xl font-semibold text-gray-800">DSP Dashboard - {{ Auth::user()->state }} State</h1>
                        </div>
                    </div>
