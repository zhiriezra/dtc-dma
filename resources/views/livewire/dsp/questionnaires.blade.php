<div>
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-semibold text-gray-900">My Assessments</h2>
        <div class="flex space-x-4">
            <button wire:click="export" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 flex items-center">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($questionnaires as $questionnaire)
                    <tr class="hover:bg-gray-50 cursor-pointer" wire:click="viewDetails({{ $questionnaire->id }})">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $questionnaire->business_email }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
